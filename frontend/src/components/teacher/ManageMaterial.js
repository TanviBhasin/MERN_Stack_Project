...
export default function ManageMaterial() {
  ...
  useEffect(() => {
    ...
    const changeStatus=(id,status)=>{
      ...
      ApiServices.softdeleteMaterial(qs.stringify(data)).then((res)=>{
          ...
          <div className="row">
            ...
            >
              <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
                  <h3 className="mb-3 bg-white text-center px-3">Manage Material</h3>
                  </div>
              <table className="table table-bordered wow fadeInUp" data-wow-delay="0.1s">
                ...
                {data?.map((el,index)=>(
                  <tr key={index}>
                    ...
                    <td>
                    <img src={BASE_URL+el?.material}  style={{height:"80px", width:"100px"}}/>
                    </td>

                    <td>
                      <Link to={"/teacher/editmaterial/"+el._id} className="text-primary">
